...
def train():
    ...
    retrieval_config = ModelConfig(
        ...
        features=['usuario_id', 'id', 'nombre', 'fecha', 'descripcion'],
        candidate_data_path="../../../datasets/picta_publicaciones_procesadas_sin_nulas_v2.csv",
        data_path="../../../datasets/vistas_no_nulas.csv",
        towers_layers_sizes=[],
        shuffle=10_000,
        ...
        features_data_q={
            ...
            'fecha': { 'dtype': FeaturesTypes.CategoricalString, 'w': 1 }    
        },
        features_data_c={ 
            'id': { 'dtype': FeaturesTypes.CategoricalInteger, 'w': 1 },
            'nombre': { 'dtype': FeaturesTypes.CategoricalString, 'w': 0.2 },
